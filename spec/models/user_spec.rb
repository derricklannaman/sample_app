...
describe User do
  ...
  subject { @user }  #the rspec method "subject" allows us to leave off and 
                     #yield @user in the code block 
...
describe "when an email is valid" do
  it "should be valid" do
    addresses = %w[user@foo.com A_USER@f.g.org frst.1st@foo.jp a+b@baz.cn]
